        ...
        <div className="flex flex-col lg:flex-row h-full items-center justify-center gap-x-24 text-center lg:text-left lg:pt-16">
          <div className="flex-1  lg:max-h-max order-2 lg:order-none overflow-hidden">
            <div className="container mx-auto">
              <div
                className="skill skills py-6 px-8  shadow-md "
                style={{ width: "80%" }}>
                <li>
          ...
          <motion.div
            ...
            <p className="mb-12 max-w-md">
              ...
              <br />
              <br />
              As a trainee front-end developer, I have expertise in developing
              high-quality web applications using frameworks such as Node.js and
              React.
              <br />
              <br />I am passionate about developing high-quality web
              applications and am excited to continue learning and advancing my
